...
> Anthropic Economic Research · 2026-02-16 · [原文](https://www.anthropic.com/research/india-brief-economic-index)

## TL;DR

Economic Index 印度国家简报：印度用户 Claude 使用画像。是继澳大利亚之后的第二份国别报告。

## 关键论点

- **印度是全球最大的 Claude 使用增量市场之一**
- 使用模式与欧美不同（教育 / 编程 / 内容创作占比大）
- 与 [[sources/155-Anthropic-Australia-Uses-Claude]] 是同系列

## 与本 wiki 关联

- 组合：[[sources/155-Anthropic-Australia-Uses-Claude]] · [[sources/152-Anthropic-81k-Economics]]
