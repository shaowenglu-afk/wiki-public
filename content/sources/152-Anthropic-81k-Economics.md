...
> Anthropic Economic Research × Societal Impacts · 2026-04-22 · [原文](https://www.anthropic.com/research/81k-economics)

## TL;DR

**8.1 万人**参与的**多语言质性调研**：用户如何使用 AI、期待什么、担心什么。是同类研究中**规模最大、最多语言**的一次。

## 关键论点

- **8.1 万人 + 多语言**：迄今最大规模的 AI 使用质性调研
- 补齐 Economic Index 的定量数据缺失的"情境 / 情感 / 期待"
- 与 Societal Impacts 团队协同

## 与本 wiki 关联

- 组合：[[sources/151-Anthropic-Economic-Index-Survey-Announcement]] · [[sources/155-Anthropic-Australia-Uses-Claude]] · [[sources/163-Anthropic-India-Country-Brief]]
