...
> Anthropic Economic Research · 2026-04-22 · [原文](https://www.anthropic.com/research/economic-index-survey-announcement)

## TL;DR

Anthropic Economic Index 正式启动**主动问卷调研**：不再只用日志数据，加入用户主动反馈，全面刻画 AI 对经济的影响。

## 关键论点

- 从"日志采样"扩展为"日志 + 主动问卷"双数据源
- 让**质性数据**进入经济研究
- 与 [[sources/152-Anthropic-81k-Economics]] 是同一系列的产出

## 与本 wiki 关联

- 组合：[[sources/152-Anthropic-81k-Economics]] · [[sources/162-Anthropic-AI-Fluency-Index]]
